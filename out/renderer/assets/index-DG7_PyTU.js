...
class OcrEngineClass {
  async recognize(image, language, onProgress) {
    const result = await Tesseract$1.recognize(image, language, {
      logger: (m) => {
...
function ImageUploader({ image, onImageSelect, disabled }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      tabIndex: 0,
      children: [
        image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: image, alt: "预览", className: "preview-image" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "placeholder", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "placeholder-icon", children: "📷" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "拖拽图片到此处" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "或点击上传图片" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hint", children: "支持 Ctrl+V 粘贴图片" })
        ] }),
...
function LanguageSelector({ languages: languages2, selected, onChange, disabled }) {
  const handleChange = (e) => {
    onChange(e.target.value);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "language-selector", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "language", children: "识别语言：" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "select",
      {
        id: "language",
        ...
        onChange: handleChange,
        disabled,
        children: languages2.map((lang) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: lang.code, children: lang.name }, lang.code))
      }
    )
  ] });
}
function ResultDisplay({ result, onChange }) {
  const handleChange = (e) => {
    onChange(e.target.value);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "result-display", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "识别结果：" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "textarea",
      {
        value: result,
...
function ProgressBar({ progress, status }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "progress-container", children: [
...
function App() {
  ...
  const [language, setLanguage] = reactExports.useState("chi_sim");
  const [isProcessing, setIsProcessing] = reactExports.useState(false);
  const handleImageSelect = reactExports.useCallback((imageData) => {
    setImage(imageData);
    setResult("");
    setProgress(0);
    setStatus("");
  }, []);
  const handleRecognize = reactExports.useCallback(async () => {
    if (!image) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "OCR 文字识别工具" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "main", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "control-panel", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          LanguageSelector,
          {
            languages,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "button-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: isProcessing ? "识别中..." : "开始识别"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
      ...
      isProcessing && /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { progress, status }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content-area", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResultDisplay, { result, onChange: setResult })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "footer", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "基于 Tesseract.js | 支持多语言OCR识别" }) })
  ] });
}
